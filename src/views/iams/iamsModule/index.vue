    ...
    <div class="layout-padding-auto layout-padding-view">
      <el-row>
        <div class="mb8" style="width: 100%">
          <el-button icon="folder-add" type="primary" class="ml10" @click="formDialogRef.openDialog()"
            v-auth="'iams_iamsModule_add'">
            新 增
          </el-button>
          <el-button plain :disabled="multiple" icon="Delete" type="primary"
            v-auth="'iams_iamsModule_del'" @click="handleDelete(selectObjs)">
            删除
          </el-button>
      ...
      <el-table :data="state.dataList" v-loading="state.loading" border 
        ...
        <el-table-column type="index" label="#" width="40" />
          <el-table-column prop="roomName" label="所属机房"  show-overflow-tooltip/>
          <el-table-column prop="name" label="微模块名称"  show-overflow-tooltip/>
          <el-table-column prop="size" label="机柜数量"  show-overflow-tooltip/>
...
<script setup lang="ts" name="systemIamsModule">
import { BasicTableProps, useTable } from "/@/hooks/table";
import { fetchList, delObjs } from "/@/api/iams/iamsModule";
